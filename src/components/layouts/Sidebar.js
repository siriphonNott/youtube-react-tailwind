...
const Sidebar = () => {
  const menu = {
    ...
    section2: {
      ...
      limit: 5,
      items:  [ 
        { link: '/', name: 'คลังวิดีโอ', icon: <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" className="h-6 w-6 mr-4" fill="currentColor"><g><path fill="none" d="M0 0h24v24H0z"></path><path d="M4 6H2v14c0 1.1.9 2 2 2h14v-2H4V6zm16-4H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-8 12.5v-9l6 4.5-6 4.5z"></path></g></svg>},
        { link: '/', name: 'ประวัติการเข้าชม', icon: <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" className="h-6 w-6 mr-4" fill="currentColor"><g><path d="M11.9 3.75c-4.55 0-8.23 3.7-8.23 8.25H.92l3.57 3.57.04.13 3.7-3.7H5.5c0-3.54 2.87-6.42 6.42-6.42 3.54 0 6.4 2.88 6.4 6.42s-2.86 6.42-6.4 6.42c-1.78 0-3.38-.73-4.54-1.9l-1.3 1.3c1.5 1.5 3.55 2.43 5.83 2.43 4.58 0 8.28-3.7 8.28-8.25 0-4.56-3.7-8.25-8.26-8.25zM11 8.33v4.6l3.92 2.3.66-1.1-3.2-1.9v-3.9H11z"></path></g></svg>},
        { link: '/', name: 'วิดีโอของคุณ', icon: <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" className="h-6 w-6 mr-4" fill="currentColor"><g><path d="M18.4 5.6v12.8H5.6V5.6h12.8zm0-1.8H5.6a1.8 1.8 0 0 0-1.8 1.8v12.8a1.8 1.8 0 0 0 1.8 1.9h12.8a1.8 1.8 0 0 0 1.9-1.9V5.6a1.8 1.8 0 0 0-1.9-1.8z"></path><path d="M10.2 9v6.5l5-3.2-5-3.2z"></path></g></svg>},
        { link: '/', name: 'ดูภายหลัง', icon: <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" className="h-6 w-6 mr-4" fill="currentColor"><g><path d="M12 3.67c-4.58 0-8.33 3.75-8.33 8.33s3.75 8.33 8.33 8.33 8.33-3.75 8.33-8.33S16.58 3.67 12 3.67zm3.5 11.83l-4.33-2.67v-5h1.25v4.34l3.75 2.25-.67 1.08z"></path></g></svg>},
        { link: '/', name: 'Tailwind', icon: <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" className="h-6 w-6 mr-4" fill="currentColor"><g><path d="M3.67 8.67h14V11h-14V8.67zm0-4.67h14v2.33h-14V4zm0 9.33H13v2.34H3.67v-2.34zm11.66 0v7l5.84-3.5-5.84-3.5z"></path></g></svg>},
        { link: '/', name: 'Work song', icon: <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" className="h-6 w-6 mr-4" fill="currentColor"><g><path d="M3.67 8.67h14V11h-14V8.67zm0-4.67h14v2.33h-14V4zm0 9.33H13v2.34H3.67v-2.34zm11.66 0v7l5.84-3.5-5.84-3.5z"></path></g></svg>},
        { link: '/', name: 'วิดีโอที่ชอบ', icon: <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" className="h-6 w-6 mr-4" fill="currentColor"><g><path d="M3.75 18.75h3v-9h-3v9zm16.5-8.25c0-.83-.68-1.5-1.5-1.5h-4.73l.7-3.43.03-.24c0-.3-.13-.6-.33-.8l-.8-.78L8.7 8.7c-.3.26-.45.64-.45 1.05v7.5c0 .82.67 1.5 1.5 1.5h6.75c.62 0 1.15-.38 1.38-.9l2.27-5.3c.06-.18.1-.36.1-.55v-1.5z"></path></g></svg>},
      ],
    },
    section3: {
      title: 'การติดตาม',
      limit: 10,
      items:  [ 
        { link: '/', name: 'Joma Tech', live: true, icon: <img width="24" height="24" className="rounded-full mr-4" alt="" src="https://yt3.ggpht.com/ytc/AKedOLTFLnUPOScnD78_Lz7YCbp0PXSpPgBTI4HA0pA8=s88-c-k-c0x00ffffff-no-rj"></img>},
        { link: '/', name: 'Flutter', live: true, icon: <img width="24" height="24" className="rounded-full mr-4" alt="" src="https://yt3.ggpht.com/ytc/AKedOLRt1d4p7bPylasq_66BIC8-k3hkyVjJ2JICQITK=s88-c-k-c0x00ffffff-no-rj"></img>},
        { link: '/', name: 'Vue Mastery', live: true, icon: <img width="24" height="24" className="rounded-full mr-4" alt="" src="https://yt3.ggpht.com/ytc/AKedOLTaTTjZNnrrDe78dmFGsvjpEmraDQ1jUTLG8_Up=s88-c-k-c0x00ffffff-no-rj"></img>},
        { link: '/', name: 'GMM GRAMMY OFFICIAL', live: true, icon: <img width="24" height="24" className="rounded-full mr-4" alt="" src="https://yt3.ggpht.com/ytc/AKedOLTil9FZJAanF4diQXzDBw2X8m9oBYQCnw1_ml66jw=s88-c-k-c0x00ffffff-no-rj"></img>},
        { link: '/', name: 'Trap Nation', live: true, icon: <img width="24" height="24" className="rounded-full mr-4" alt="" src="https://yt3.ggpht.com/ytc/AKedOLR3UYYjp461bQEzYvaT4yNk5p50sh9VPBKCnM4C8Q=s88-c-k-c0x00ffffff-no-rj"></img>},
        { link: '/', name: 'Code Pioneers', new: true, icon: <img width="24" height="24" className="rounded-full mr-4" alt="" src="https://yt3.ggpht.com/ytc/AKedOLSjTRax0gnh5VYLVJHiSLznx2VNnSTRF7NKOTgG=s88-c-k-c0x00ffffff-no-rj"></img>},
        { link: '/', name: 'เรื่องเล่าเช้านี้', new: true, icon: <img width="24" height="24" className="rounded-full mr-4" alt="" src="https://yt3.ggpht.com/ytc/AKedOLSXiw86azYZBp8uy36XH6NPSoDk6wwy857-qj4C-A=s88-c-k-c0x00ffffff-no-rj"></img>},
        { link: '/', name: 'NottDev', new: true, icon: <img width="24" height="24" className="rounded-full mr-4" alt="" src="https://yt3.ggpht.com/ytc/AKedOLTLuUPlwgw1eS2TP5-rXDe2VXBXrAOCq0UkSGVW=s88-c-k-c0x00ffffff-no-rj"></img>},
      ],
    },
  }
